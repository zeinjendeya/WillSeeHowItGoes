...
export default function Dropdown({ name, links }: DropdownProps) {
  return (
    <li
      className="relative group/main inline-block text-left"
    >
      <a
        href="#"
